...
<strong>ape博客（以下称“ape_blog”），由里派网络科技有限公司（以下称“里派科技”）独创开发，版权所有Copyright (c)2020-2030，里派科技保留所有权利。ape_blog是国内最稳定、最强大、最先进的互联网电商平台解决方案之一，APE_BLOG基于 PHP + MySQL 的技术，采用ThinkPHP框架开发。APE_BLOG官方对此拥有最终修改权和解释权。</strong>
APE_BLOG官方网站：http://www.apecloud.cn
<strong>在使用ape博客（以下称“许可软件”或“本软件”）之前，请您仔细阅读本协议，特别是法律适用和争议解决条款，此等条款将以粗体标识，您需要重点阅读。如您对协议有任何疑问，可向客服咨询。如果您已下载、复制、安装或以其他任何方式使用该软件，则视为已经接受本协议。如果您不接受本协议的全部或部分条款，您将无权使用本软件。请立即终止安装、或以其他方式使用该软件，删除您已经安装或保留的该软件的任何组件。</strong>
...
<br/>
一、定义
软件（许可软件或本软件）：本协议中的“软件”是指ape博客系统，由若干模块或功能组成的已经植入或即将植入里派科技指定产品内的信息处理程序或支持文件，其中支持文件具体包括软件的源代码、目标码以及相关软件中所包含的图片、照片、图标、动画、录音、录像、音乐、文字、代码的全部或部分，还包括与许可软件或众邦产品相关的所有描述其功能、特点、内容、质量、测试、用户手册、用户许可协议等纸质或电子版的资料、技术文档等。
您：本协议中的“您”是指取得里派科技合法许可使用本软件权利的个人或单个法人实体，法人实体包括公司、企业、机构、组织或单位。
我们：本协议中的“我们”即是APE_BLOG官方，是指里派科技，即里派网络科技有限公司及其关联公司。
...
7、APE_BLOG著作权已在中华人民共和国国家版权局注册(中国国家版权局著作权登记号 2018SR024463)，著作权受到法律和国际公约保护。未经我们书面许可，不得删除网站底部及相应的官方链接。购买商业授权请联系里派科技了解最新说明。
